import { GestOperacoesFacade } from '../../core/GestOperacoesFacade';

describe('GestOperacoesFacade - Testes Unitários', () => {
  let facade: GestOperacoesFacade;
  let mockDiarioDAO: any;
  let mockUtilizadoresDAO: any;

  beforeEach(() => {
    facade = new GestOperacoesFacade();

    mockDiarioDAO = (facade as any).diarioDAO;
    mockUtilizadoresDAO = (facade as any).utilizadoresDAO;
