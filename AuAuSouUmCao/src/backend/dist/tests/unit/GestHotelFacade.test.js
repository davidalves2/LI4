...
describe('GestorHotelFacade - Testes Unitários', () => {
    ...
    let mockGestHospedes;
    let mockGestReservas;
    let mockGestOperacoes;
    let mockGestFaturacao;
    let mockGestClinica;
    beforeEach(() => {
        facade = new GestorHotelFacade_1.GestorHotelFacade();
        // Capturar as instâncias privadas criadas no constructor
        mockGestHospedes = facade.gestHospedes;
        mockGestReservas = facade.gestReservas;
        mockGestOperacoes = facade.gestOperacoes;
        mockGestFaturacao = facade.gestFaturacao;
        mockGestClinica = facade.gestClinica;
